...
class ProductsController extends Controller
{
    ...
    public function addToCart(Request $request){
        ...
        if($addCart){
            return Redirect::route("single.product",$request->pro_id)->with(['success'=>'product added to cart']);
        }
    ...
    public function deleteFromCart($id){
        ...
        $deleteCart->delete();
        if($deleteCart){
            return Redirect::route("products.cart")->with(['delete'=>'product removed from cart']);
        }
...
public function success(){
    $deleItemsFromCart = Cart::where('user_id',Auth::user()->id);
    $deleItemsFromCart->delete();
    if($deleItemsFromCart){
